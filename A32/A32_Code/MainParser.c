...
/* External objects */
extern viper_intg syntaxErrorNumber /* number of syntax errors reported by the parser */;
extern viper_intg line; /* source code line number - defined in scanner.c */
...
extern viper_void startParser(viper_void);
extern viper_intg startScanner(ReaderPointer sc_buf);

static viper_void printParserError(viper_char* fmt, ...);
static viper_void displayParser(ReaderPointer ptrBuffer);
static viper_long getParserFileSize(viper_char* fname);
static viper_void callGarbageCollector(viper_void);
...
viper_void printParserError(viper_char* fmt, ...) {
...
viper_long getParserFileSize(viper_char* fname) {
	FILE* input;
	viper_long flength;
	input = fopen(fname, "r");
	if (input == NULL) {
...
viper_void displayParser(ReaderPointer ptrBuffer) {
...
viper_void callGarbageCollector(viper_void) {
